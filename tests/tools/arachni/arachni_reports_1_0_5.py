report_low = """<report xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/Arachni/arachni/v1.0.5/components/reporters/xml/schema.xsd">
...
report_high = """<report xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/Arachni/arachni/v1.0.5/components/reporters/xml/schema.xsd">
  <version>1.0.5</version>
  <options>---
datastore:
  report_path: 
...
url: http://10.12.68.25:31337/
  ...
  <start_datetime>2015-05-19T16:39:26+02:00</start_datetime>
  <finish_datetime>2015-05-19T16:40:54+02:00</finish_datetime>
  <sitemap>
    <entry url="http://10.12.68.25:31337/" code="200"/>
    ...
    &lt;/form&gt;</html>
      ...
      <variations>
        <variation>
          <vector>
            <method>post</method>
            <seed>()"&amp;%1'-;&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'</seed>
            <inputs>
              <input name="pseudo" value="1"/>
              <input name="message" value="1()&quot;&amp;%1'-;&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'"/>
            </inputs>
          </vector>
          <remarks/>
          <page>
            <body>Error: You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near ';&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'')' at line 1
Message added successfullygo back to &lt;a href='/'&gt;messages&lt;/a&gt;</body>
            <request>
              <url>http://10.12.68.25:31337/post</url>
              <method>post</method>
              ...
              <body>pseudo=1&amp;message=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_d7621ff8f3f1957db05ffaca9375a282%2F%3E%27</body>
              <raw>POST /post HTTP/1.1&#xD;
Host: 10.12.68.25:31337&#xD;
Accept-Encoding: gzip, deflate&#xD;
User-Agent: Arachni/v1.0.5&#xD;
...
Content-Type: application/x-www-form-urlencoded&#xD;
&#xD;
pseudo=1&amp;message=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_d7621ff8f3f1957db05ffaca9375a282%2F%3E%27</raw>
            </request>
            <response>
              <url>http://10.12.68.25:31337/post</url>
              <code>200</code>
...
&#xD;
          ...
          <signature/>
          <proof>&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;</proof>
          <trusted>true</trusted>
          <platform_type/>
          <platform_name/>
        </variation>
      ...
      <variations>
        <variation>
          <vector>
            ...
            <seed>()"&amp;%1'-;&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'</seed>
            <inputs>
              <input name="pseudo" value="1()&quot;&amp;%1'-;&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'"/>
              <input name="message" value="1"/>
            </inputs>
          </vector>
          <remarks/>
          <page>
            <body>Error: You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near ';&lt;some_dangerous_input_d7621ff8f3f1957db05ffaca9375a282/&gt;'', '1')' at line 1
Message added successfullygo back to &lt;a href='/'&gt;messages&lt;/a&gt;</body>
            <request>
              <url>http://10.12.68.25:31337/post</url>
              <method>post</method>
              ...
              <body>pseudo=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_d7621ff8f3f1957db05ffaca9375a282%2F%3E%27&amp;message=1</body>
              <raw>POST /post HTTP/1.1&#xD;
Host: 10.12.68.25:31337&#xD;
Accept-Encoding: gzip, deflate&#xD;
User-Agent: Arachni/v1.0.5&#xD;
...
Content-Type: application/x-www-form-urlencoded&#xD;
&#xD;
pseudo=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_d7621ff8f3f1957db05ffaca9375a282%2F%3E%27&amp;message=1</raw>
            </request>
            <response>
              <url>http://10.12.68.25:31337/post</url>
              <code>200</code>
