report_low = r"""<report xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/Arachni/arachni/v1.0/components/reporters/xml/schema.xsd">
  <version>1.0</version>
  <options>---
http:
  user_agent: Arachni/v1.0
...
url: http://192.168.1.24:9000/
  ...
  <start_datetime>2014-10-07T00:13:26+02:00</start_datetime>
  <finish_datetime>2014-10-07T00:13:37+02:00</finish_datetime>
  <sitemap>
    ...
    &lt;a href='/cake'&gt;reload the current page&lt;/a&gt;
            ...
            <request>
              ...
              <headers>
                ...
                <header name="User-Agent" value="Arachni/v1.0"/>
              </headers>
              <body/>
...
report_high = r"""<report xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/Arachni/arachni/v1.0/components/reporters/xml/schema.xsd">
  <version>1.0</version>
  <options>---
http:
  user_agent: Arachni/v1.0
...
url: http://192.168.1.24:9000/
  ...
  <start_datetime>2014-10-07T00:27:55+02:00</start_datetime>
  <finish_datetime>2014-10-07T00:29:55+02:00</finish_datetime>
  <sitemap>
    <entry url="http://192.168.1.24:9000/" code="200"/>
    ...
    &lt;/form&gt;</html>
      ...
      <variations>
        <variation>
          <vector>
            <method>post</method>
            <seed>()"&amp;%1'-;&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;'</seed>
            <inputs>
              <input name="pseudo" value="1()&quot;&amp;%1'-;&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;'"/>
              <input name="message" value="1"/>
            </inputs>
          </vector>
          <remarks/>
          <page>
            <body>Error: You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near ';&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;'', '1')' at line 1
Message added successfullygo back to &lt;a href='/'&gt;messages&lt;/a&gt;</body>
            <request>
              <url>http://192.168.1.24:9000/post</url>
              <method>post</method>
              ...
              <body>pseudo=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_53b0dba585e263315f409b5798e76ebc%2F%3E%27&amp;message=1</body>
              <raw>POST /post HTTP/1.1&#xD;
Host: 192.168.1.24:9000&#xD;
Accept-Encoding: gzip, deflate&#xD;
User-Agent: Arachni/v1.0&#xD;
...
Content-Type: application/x-www-form-urlencoded&#xD;
&#xD;
pseudo=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_53b0dba585e263315f409b5798e76ebc%2F%3E%27&amp;message=1</raw>
            </request>
            <response>
              <url>http://192.168.1.24:9000/post</url>
              <code>200</code>
...
&#xD;
          ...
          <signature/>
          <proof>&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;</proof>
          <trusted>true</trusted>
          <platform_type/>
          <platform_name/>
        </variation>
      ...
      <variations>
        <variation>
          <vector>
            ...
            <inputs>
              <input name="pseudo" value="1"/>
              <input name="message" value="1()&quot;&amp;%1'-;&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;'"/>
            </inputs>
          </vector>
          <remarks/>
          <page>
            <body>Error: You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near ';&lt;some_dangerous_input_53b0dba585e263315f409b5798e76ebc/&gt;'')' at line 1
Message added successfullygo back to &lt;a href='/'&gt;messages&lt;/a&gt;</body>
            <request>
              <url>http://192.168.1.24:9000/post</url>
              <method>post</method>
              ...
              <body>pseudo=1&amp;message=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_53b0dba585e263315f409b5798e76ebc%2F%3E%27</body>
              <raw>POST /post HTTP/1.1&#xD;
Host: 192.168.1.24:9000&#xD;
Accept-Encoding: gzip, deflate&#xD;
User-Agent: Arachni/v1.0&#xD;
...
Content-Type: application/x-www-form-urlencoded&#xD;
&#xD;
pseudo=1&amp;message=1%28%29%22%26%251%27-%3B%3Csome_dangerous_input_53b0dba585e263315f409b5798e76ebc%2F%3E%27</raw>
            </request>
            <response>
              <url>http://192.168.1.24:9000/post</url>
              <code>200</code>
